        ...
        <section className="section-padding">
            <div className="auto-container">
                <div className="section_heading text-center mb_60">
                    ...
                    <h2 className="section_heading_title_big">Dernières Actualités & <br/> Rapports de l'ATR</h2>
                </div>
                <div className="row">
                    <div className="col-lg-4 col-md-6">
                        <div className="blog-1-block wow fadeInLeft" data-wow-delay=".2s" data-wow-duration=".8s">
                            ...
                            <div className="blog-1-bottom-content alt mb_30">
                                ...
                                <p className="blog-1-excerpt">Le guide officiel pour le dimensionnement <br/> des chaussées neuves en Tunisie.</p>
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="blog-1-block wow fadeInLeft" data-wow-delay=".2s" data-wow-duration=".8s">
                            ...
                            <div className="blog-1-bottom-content alt mb_30">
                                ...
                                <p className="blog-1-excerpt">Analyse approfondie des accidents de la route <br/> et propositions d'aménagements.</p>
                                <div className="blog-1-link-btn"><Link href="/blog-details" className="btn-1 alt">Lire la suite <span></span></Link></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="blog-1-block wow fadeInLeft" data-wow-delay=".2s" data-wow-duration=".8s">
                        ...
                        <div className="blog-1-bottom-content alt mb_30">
                            ...
                            <p className="blog-1-excerpt">Étude d'impact des inondations sur <br/> le réseau routier tunisien.</p> 
                            <div className="blog-1-link-btn"><Link href="/blog-details" className="btn-1 alt">Lire la suite <span></span></Link></div>
                        </div>
                    </div>
                </div>
